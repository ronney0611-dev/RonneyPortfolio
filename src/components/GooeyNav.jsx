...
const GooeyNav = ({
  ...
  // -----------------------------
  // Update effect position for animation
  // -----------------------------
  ...
  // -----------------------------
  // Animate text effect (bubble/pill)
  // -----------------------------
  if (textRef.current) {
  ...
  // -----------------------------
  const scrollDelay = 800; // adjust as you like
  setTimeout(() => {
            ...
            {items.map((item, index) => (
              <li
                ...
                <a
                  ...
                  href={item.href} // keep this for accessibility/fallback
